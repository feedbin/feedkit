...
class Feedkit::Parser::XMLEntryTest < Minitest::Test
  ...
  def test_public_id_with_entry_id
    ...
    assert_equal("8f868cbd28d3ff6488671641cbce6183", parsed_entry.to_entry[:fingerprint])
  ...
  def test_public_id_without_entry_id_and_published_and_title
    ...
    parsed_entry = ::Feedkit::Parser::XMLEntry.new(entry, feed_url)
    assert_equal("27aa8c55201e5701e43a333fe70e2e321be4633c", parsed_entry.public_id)
    assert_equal("fb27f4b6cf040f3dd93f9deb64345c1c", parsed_entry.to_entry[:fingerprint])
    assert_equal("6611b142cd5d7d20a3221d4e37fefdf7", parsed_entry.guid)
  end
  ...
  def test_public_id_without_entry_id_and_url
    ...
    assert_equal("b29e4436db3e53216bd3f32357691f09", parsed_entry.to_entry[:fingerprint])
  ...
  def test_alternate_entry_id_http
    ...
    assert_equal("e82b331e29beb47f4a71f4081784873f", parsed_entry.to_entry[:fingerprint])
  ...
  def test_entry_id_structure
    ...
    assert_equal("cc8944b052a174ec5c95715c43c776cd", parsed_entry.to_entry[:fingerprint])
  end
  ...
  def test_alternate_entry_id_https
    ...
    assert_equal("3c5b0351cc9dfa03098bc2237ca27b9f", parsed_entry.to_entry[:fingerprint])
    assert_equal("59c16ef3165eb0b4ec40bf4e2a52e9d4", parsed_entry.guid)
  end
  ...
  def test_public_id_alt_with_entry_id_http
    ...
    assert_equal("d3364b92055ac05c60cd403d2d218983", parsed_entry.to_entry[:fingerprint])
  ...
  def test_public_id_alt_with_port
    ...
    assert_equal("77f0b30bce0b2dbdf3841e9564509fa1", parsed_entry.to_entry[:fingerprint])
